...
export default async function AuthLayout({
  ...
  return (
    <div className="flex min-h-[calc(100svh-4rem)] flex-col overflow-hidden px-4 py-4 sm:py-6">
      ...
      <div className="pt-3">
        <div className="mx-auto flex w-full max-w-md flex-wrap items-center justify-center gap-x-3 gap-y-1 rounded-full border border-black/8 bg-white/35 px-4 py-2 text-[0.72rem] text-muted-foreground backdrop-blur-xl dark:border-white/10 dark:bg-black/20">
