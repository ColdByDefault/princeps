...
export function GoalCard({
  ...
  const fields: DetailField[] = [
    { label: t("fields.status"), value: t(`status.${goal.status}`) },
    {
      ...
      hidden: !goal.description,
    },
    {
      label: t("fields.targetDate"),
      value: goal.targetDate ? formatDate(goal.targetDate, locale) : null,
      hidden: !goal.targetDate,
    },
    {
      label: t("fields.milestones"),
      value: (
      ...
      hidden: !goal.milestones.length,
    },
    {
      label: t("fields.linkedTasks"),
      value: (
    ...
    },
    {
      ...
      hidden: !goal.labels.length,
    },
    {
      label: t("viewDialog.createdAt"),
      value: formatDate(goal.createdAt, locale),
    },
  ];
