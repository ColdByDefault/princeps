...
- **Auth**: Better Auth
- **LLM**: OpenAI (via `lib/ai/llm-providers/`)
...
lib/ai/tools/                         Tool orchestration (feature-agnostic)
...
lib/ai/llm-providers/                 LLM provider abstraction
lib/ai/context/                       System prompt assembly (slots per feature)
lib/core/                             Shared infrastructure (db, auth, utils, security, seo)
lib/platform/                         Billing, tiers, settings, integrations
lib/services/                         External API clients (weather, web-research)
