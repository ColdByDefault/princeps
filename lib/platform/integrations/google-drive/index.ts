...
import { embedBatch } from "@/lib/ai/llm-providers";
import { accumulateTokens, enforceKnowledgeUpload } from "@/lib/platform/tiers/enforce";
import {
  chunkText,
  normalizeVector,
  EMBEDDING_DIM,
...
import { markSynced } from "@/lib/platform/integrations/shared/upsert";
